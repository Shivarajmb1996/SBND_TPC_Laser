...
class Attenuator(Motor):
    ...
    def getParameter(self, parameter):
        ...
        startStringValue = reply.find(instruction.encode()) + len(instruction)
        endStrinValue = reply[startStringValue:].find(" ".encode()) + startStringValue
    ...
    def getPosition(self):
        ...
        semicolon_pos = (reply.decode().find(";"))
    ...
    def checkParameter(self, parameter, value, echo):
        SetValue = self.getParameter(parameter).decode()
