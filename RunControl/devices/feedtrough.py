...
class Feedtrough(Motor):
    ...
    def com_write_(self, msg):
        ...
        try:
            ...
            self.com.write((str(self.axis) + msg + self.comEnd).encode('ascii'))
    ...
    # cant put flush here because getVariable will be incomplete if we do it.
        msg = "PR " + parameter
        self.com_write(msg)
        if parameter == str('AL'):
    ...
    def sendCommand(self, command, attribute=""):
        ...
        print("_____feedthrough 190__", msg.encode('ascii'))
        self.com_write(msg)
...
#        self.sendCommand("MR", str(microsteps))
#        print("_______feedthrough 199_ moveRelative_end")
#        
#        reply = self.com_recv(msg_length=100)
#            ###########################
#        print("_______feedthrough 216",reply)
#        if monitor:
...
#        if monitor:
#            self.monitorMovement()
#___________________Copied from python2 - start___________________________________
    ...
    def moveRelative(self, microsteps, monitor=False):
        ...
        if self.MAX_HOMING_OVERSHOOT > (now+microsteps) > -1*(self.MAX_HOMING_OVERSHOOT):
            ...
            #_____________not needed_________________
            reply = self.com_recv(msg_length=100)
            print("_______feedthrough 216",reply)
            #________not needed till here_________________
...
#__________________copied from ython 2 end_________________________________________
